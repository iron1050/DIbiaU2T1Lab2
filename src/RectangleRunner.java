...
public class RectangleRunner {
    public static void main(String[] args) {
        ...
        double rect1Volume = rect1.calculateBoxVolume(rect2Height);
        System.out.print("Rectangle 1's Area: " + rect1Area + ", Box Volume: " + rect1Volume);
        System.out.print("Rectangle 2's Area: " + rect2Area + ", Box Volume: " + rect2Volume);
